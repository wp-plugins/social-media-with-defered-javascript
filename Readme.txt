...
1. Upload `Social media with defered Javascript` folder to your WP plugin folder `/wp-content/plugins/` directory
2. The path must look like this: `/wp-content/plugins/Social-Media-with-defered-Javascript/`
3. Activate the plugin through the 'Plugins' menu in WordPress
4. You are ready, check the buttons on each post of your site.
